    ...
    \begin{uloha}{1}{2}{
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                ...
                \filldraw[black] (0,0) circle (2pt) node[anchor=north, yshift=-1ex] {$1$};
                \filldraw[red] (1,0) circle (2pt) node[anchor=north, yshift=-1ex] {$2$};
                \filldraw[black] (2,0) circle (2pt) node[anchor=north, yshift=-1ex] {$3$};
                \filldraw[red] (3,0) circle (2pt) node[anchor=north, yshift=-1ex] {$\ldots$};
                \filldraw[black] (4,0) circle (2pt) node[anchor=north, yshift=-1ex] {$n$};
            \end{tikzpicture}
            \caption{Cesta $P_n$}
        ...
        \answerbox{
            \begin{itemize}
                \item $\delta(P_n) = 1$
                \item $\Delta(P_n) = 2$
                \item Skóre grafu $P_n = \{1, 2, 2, \dots, 2, 1\} = 2n - 2$
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}[b]{0.49\textwidth}
                ...
                \begin{tikzpicture}[y=-0.5cm,x=0.5cm]
                    ...
                    \draw[>=stealth] (3,1) -- (2.66,2.33);
                    \draw[>=stealth] (2.66,2.33) -- (1.33,2.33);
                    \draw[>=stealth] (1.33,2.33) -- (1,1);
                    \draw[>=stealth] (1,1) -- (2,0);
                    \filldraw[black] (2,0) circle (2pt) node[anchor=south, yshift=1ex] {$1$};
                    \filldraw[red] (3,1) circle (2pt) node[anchor=west, xshift=1ex] {$2$};
                    \filldraw[black] (2.66,2.33) circle (2pt) node[anchor=north, yshift=-1ex] {$3$};
                    \filldraw[red] (1.33,2.33) circle (2pt) node[anchor=north, yshift=-1ex] {$4$};
                    \filldraw[green] (1,1) circle (2pt) node[anchor=east, xshift=-1ex] {$5$};
                \end{tikzpicture}
                \caption{Lichá kružnice $C_5$}
                \label{fig:ukol-2-1b-kruznice-5}
            \end{subfigure}
            \hfill
            \begin{subfigure}[b]{0.49\textwidth}
                \centering
                \begin{tikzpicture}[y=-0.5cm,x=0.5cm]
                    \draw[>=stealth] (1,0) -- (2,0.8);
                    \draw[>=stealth] (2,0.8) -- (2,2.2);
                    \draw[>=stealth] (2,2.2) -- (1,3);
                    \draw[>=stealth] (1,3) -- (0,2.2);
                    \draw[>=stealth] (0,2.2) -- (0,0.8);
                    \draw[>=stealth] (0,0.8) -- (1,0);
                    \filldraw[red] (1,0) circle (2pt) node[anchor=south, yshift=1ex] {$1$};
                    \filldraw[black] (2,0.8) circle (2pt) node[anchor=west, xshift=1ex] {$2$};
                    \filldraw[red] (2,2.2) circle (2pt) node[anchor=west, xshift=1ex] {$3$};
                    \filldraw[black] (1,3) circle (2pt) node[anchor=north, yshift=-1ex] {$4$};
                    \filldraw[red] (0,2.2) circle (2pt) node[anchor=east, xshift=-1ex] {$5$};
                    \filldraw[black] (0,0.8) circle (2pt) node[anchor=east, xshift=-1ex] {$6$};
                \end{tikzpicture}
                \caption{Sudá kružnice $C_6$}
                \label{fig:ukol-2-1b-kruznice-6}
            \end{subfigure}
        \end{figure}
        ...
        \answerbox{
            \begin{itemize}
                \item $\delta(C_n) = 2$
                \item $\Delta(C_n) = 2$
                \item Skóre grafu $C_n = \{2, 2, \dots, 2\} = 2n$
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[y=-1cm]
                ...
                \draw (0,-1) -- (1,-1);
                \draw (1,0) -- (1,-1);
                \filldraw[black] (0,0) circle (2pt) node[anchor=north east] {$1$};
                \filldraw[red] (0,-1) circle (2pt) node[anchor=south east] {$2$};
                \filldraw[green] (1,0) circle (2pt) node[anchor=north west] {$3$};
                \filldraw[blue] (1,-1) circle (2pt) node[anchor=south west] {$4$};
            \end{tikzpicture}
        ...
        \answerbox{
            \begin{itemize}
                \item $\delta(K_n) = n-1$
                \item $\Delta(K_n) = n-1$
                \item Skóre grafu $K_n = \{n-1, n-1, \dots, n-1\} = n(n-1)$
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[y=-0.5cm]
                ...
                \filldraw[black] (0,1) circle (2pt) node[anchor=east] {$2$};
                \filldraw[black] (0,2) circle (2pt) node[anchor=east] {$3$};
                \filldraw[red] (2,0) circle (2pt) node[anchor=west] {$4$};
                \filldraw[red] (2,1) circle (2pt) node[anchor=west] {$5$};
                \filldraw[red] (2,2) circle (2pt) node[anchor=west] {$6$};
            \end{tikzpicture}
        ...
        \answerbox{
            \begin{itemize}
                \item $\delta(K_{m,n}) = \min(m,n)$
                \item $\Delta(K_{m,n}) = \max(m,n)$
                \item Skóre grafu $K_{m,n} = \{m, m, \dots, m, n, n, \dots, n\} = m \cdot n$
        ...
        \answerbox{
            \begin{itemize}
                ...
                \item $\Delta(PG_{18, 27}) = 3$
                \item Skóre grafu $PG_{18, 27} = \{3, 3, \dots, 3\} = 54$
...
% -- Úloha 9
    \begin{uloha}{9}{2}{
        ...
        \begin{figure}[H]
            \centering
            \begin{tikzpicture}
                \node[circle, draw, inner sep=2pt, fill=black, label=above:{1}] (1) at (3,3) {};
                \foreach \i in {2,...,8}
                \node[circle, draw, inner sep=2pt, fill=red, label=above:{\i}] (\i) at ({3+cos(360/7*\i)},{3+sin(
                360/7
                *\i)}) {};
                \foreach \i in {2,...,8}
                \draw[>=stealth] (1) -- (\i);
        ...
        \answerbox{
            Největší hodnota nezávislosti $\alpha(G)$ je docílena na hvězdicovém stromu o velikosti $n$, kde $\alpha(G) = n-1$.
        }{9a}
            ...
            \begin{tikzpicture}[y=-1cm]
                \foreach \i in {1,...,8}{
                    \ifthenelse{
                        ...
                        \node[circle, draw, inner sep=2pt, fill=red, label=above:{\i}] (\i) at (\i,0) {};
                    }{
                        \node[circle, draw, inner sep=2pt, fill=black, label=above:{\i}] (\i) at (\i,0) {};
                    }
                }
        ...
        \answerbox{
            Nejmenší hodnota nezávislosti $\alpha(G)$ je docílena na cestě o velikosti $n$, kde $\alpha(G) = \frac{n}{2}$.
        }{9b}

        \subsection{c) Největší hodnota vrcholového pokrytí $\beta(G)$}
        Jak jsme si již ukázali v předchozích bodech, největší hodnota vrcholového pokrytí $\beta(G)$ bude docílena na cestě $P_n$, kde $\beta(G) = \frac{n}{2}$.
        \begin{figure}[H]
            \centering
            \begin{tikzpicture}[y=-1cm]
                \foreach \i in {1,...,8}{
            ...
            \end{tikzpicture}
            \caption{Cesta o velikosti $n=8$}
            \label{fig:ukol-2-9-cesta-2}
        \end{figure}

        \answerbox{
            Největší hodnota vrcholového pokrytí $\beta(G)$ je docílena na cestě o velikosti $n$, kde $\beta(G) = \frac{n}{2}$.
        }{9c}

        \subsection{d) Nejmenší hodnota vrcholového pokrytí $\beta(G)$}
        Naopak opět se vracíme k hvězdicovému stromu, kde jsme dále zjistili, že nejmenší hodnota vrcholového pokrytí $\beta(G)$ bude docílena na hvězdicovém stromu, kde $\beta(G) = 1$ a to díky kořeni stromu, který pokryje všechny hrany.

        \begin{figure}[H]
            \centering
            \begin{tikzpicture}
                \node[circle, draw, inner sep=2pt, fill=red, label=above:{1}] (1) at (3,3) {};
                \foreach \i in {2,...,8}
                \node[circle, draw, inner sep=2pt, fill=black, label=above:{\i}] (\i) at ({3+cos(360/7*\i)},{3+sin(
                360/7
                *\i)}) {};
                \foreach \i in {2,...,8}
                \draw[>=stealth] (1) -- (\i);
            \end{tikzpicture}
            \caption{Hvězdicový strom o velikosti $n=8$}
            \label{fig:ukol-2-9-hvezdicovy-strom-2}
        \end{figure}

        \answerbox{
            Nejmenší hodnota vrcholového pokrytí $\beta(G)$ je docílena na hvězdicovém stromu o velikosti $n$, kde $\beta(G) = 1$.
        }{9d}
    \end{uloha}
...
% -- Úloha 12
    \begin{uloha}{12}{2}{
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.65\textwidth]{\FIGDIR/ukol-2-12-hand}
...
% -- Úloha 13
    \begin{uloha}{13}{2}{
        ...
        Pro tu nyní sestrojíme graf:
        \begin{figure}[H]
            \centering
            \resizebox{0.35\paperwidth}{!}{
                \begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=3cm,semithick,y=-1cm]
                    % c1
                    \draw[fill=gray!20,draw=none] (0, 4) ellipse (0.5 and 2.5);
                    \node[anchor=center,fill=gray!20, circle] at (0, 1) {$c_1$};
                    \filldraw[black] (0,2) circle (2pt) node[anchor=south east] {$a_{11}$};
                    \filldraw[black] (0,4) circle (2pt) node[anchor=south east] {$a_{12}$};
                    \filldraw[black] (0,6) circle (2pt) node[anchor=south east] {$a_{13}$};
                    % c2
                    \draw[fill=gray!20,draw=none] (2, 2) ellipse (0.5 and 2.5);
                    \node[anchor=center,fill=gray!20, circle] at (2, -1) {$c_2$};
                    \filldraw[black] (2,0) circle (2pt) node[anchor=south east] {$a_{21}$};
                    \filldraw[black] (2,2) circle (2pt) node[anchor=south east] {$a_{22}$};
                    \filldraw[black] (2,4) circle (2pt) node[anchor=south east] {$a_{23}$};
                    % c3
                    \draw[fill=gray!20,draw=none] (4, 3) ellipse (0.5 and 3.5);
                    \node[anchor=center,fill=gray!20, circle] at (4, -1) {$c_3$};
                    \filldraw[black] (4,0) circle (2pt) node[anchor=south east] {$a_{31}$};
                    \filldraw[black] (4,4) circle (2pt) node[anchor=south east] {$a_{32}$};
                    \filldraw[black] (4,6) circle (2pt) node[anchor=south east] {$a_{33}$};
                    % c4
                    \draw[fill=gray!20,draw=none] (6, 3) ellipse (0.5 and 3.5);
                    \node[anchor=center,fill=gray!20, circle] at (6, -1) {$c_4$};
                    \filldraw[black] (6,0) circle (2pt) node[anchor=north east] {$a_{41}$};
                    \filldraw[black] (6,2) circle (2pt) node[anchor=north east] {$a_{42}$};
                    \filldraw[black] (6,4) circle (2pt) node[anchor=north east] {$a_{43}$};
                    \filldraw[black] (6,6) circle (2pt) node[anchor=north east] {$a_{44}$};
                    % c5
                    \draw[fill=gray!20,draw=none] (8, 7) ellipse (0.5 and 1.5);
                    \node[anchor=center,fill=gray!20, circle] at (8, 5) {$c_5$};
                    \filldraw[black] (8,6) circle (2pt) node[anchor=south east] {$a_{51}$};
                    \filldraw[black] (8,8) circle (2pt) node[anchor=south east] {$a_{52}$};
                    % c1 - complete
                    \draw (0,2) to (0,4);
                    \draw (0,4) to (0,6);
                    \draw (0,6) to [bend right] (0,2);
                    % c2 - complete
                    \draw (2,0) to (2,2);
                    \draw (2,2) to (2,4);
                    \draw (2,4) to [bend right] (2,0);
                    % c3 - complete
                    \draw (4,0) to (4,4);
                    \draw (4,4) to (4,6);
                    \draw (4,6) to [bend right] (4,0);
                    % c4 - complete
                    \draw (6,0) to (6,2);
                    \draw (6,2) to (6,4);
                    \draw (6,4) to (6,6);
                    \draw (6,6) to [bend right] (6,0);
                    \draw (6,6) to [bend right] (6,2);
                    \draw (6,4) to [bend right] (6,0);
                    % c5 - complete
                    \draw (8,6) to (8,8);
                    % join opposite literals
                    \draw (0,2) to (2,2);
                    \draw (0,2) to [bend left] (6,2);
                    \draw (0,4) to (2,4);
                    \draw (0,4) to [bend left] (6,4);
                    \draw (0,6) to [bend left] (6,6);
                    \draw (2,0) to (4,0);
                    \draw (2,4) to (4,4);
                    \draw (4,0) to (6,0);
                    \draw (4,4) to (6,4);
            ...
            \caption{Graf sestaený z literálů a klauzulí}
            \label{fig:ukol-2-13-graf}
        \end{figure}

        Nyní musíme v každé klauzuli nalézt literál, který bude roven $1$, a tím pádem bude tato klauzule splněna.
        Tedy musíme najít nezávislou množinu v grafu:
        \begin{figure}[H]
            \centering
            \resizebox{0.35\paperwidth}{!}{
                \begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=3cm,semithick,y=-1cm]
                    % independed vertices set (a11, a21, a32, a44, a52)
                    \filldraw[red] (0,2) circle (6pt);
                    \filldraw[red] (2,0) circle (6pt);
                    \filldraw[red] (4,4) circle (6pt);
                    \filldraw[red] (6,6) circle (6pt);
                    \filldraw[red] (8,8) circle (6pt);
                    % c1
                    \filldraw[black] (0,2) circle (2pt) node[anchor=south east] {$a_{11}$};
                    \filldraw[black] (0,4) circle (2pt) node[anchor=south east] {$a_{12}$};
                    \filldraw[black] (0,6) circle (2pt) node[anchor=south east] {$a_{13}$};
            ...
            \caption{Množina nezávislých vrcholů v grafu}
            \label{fig:ukol-2-13-ind}
        \end{figure}

        Pro tuto množinu $a_{12}, a_{21}, a_{32}, a_{44}, a_{52}$ zvolíme literály rovny jedné:
        \begin{equation*}
            f(x_1=1, x_2=1, x_3=0, x_4=0, x_5=1) =
            (1 \lor 1 \lor 0) \land
            (1 \lor 0 \lor 0) \land
            (0 \lor 1 \lor 0) \land
            (1 \lor 0 \lor 0 \lor 1)
        ...
        Formule je rovna $1$ a tedy je splněna se zvolenými hodnotami literálů.

        Podrobnější postup je vidět na obrázku~\ref{fig:ukol-2-13-hand} níže:
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.75\textwidth]{\FIGDIR/ukol-2-13-hand}
            \caption{Postup nalezení nezávislé množiny a ověření formule}
            \label{fig:ukol-2-13-hand}
        \end{figure}
    ...
    \begin{uloha}{14}{2}{
        ...
        \begin{figure}[H]
            ...
            \resizebox{0.3\paperwidth}{!}{
                \begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=3cm,semithick,y=-1cm]
                    % colors: 0 -> gray, 1 -> blue, 2 -> green
                    % color u -> 0, v -> 1, w -> 2
                    \filldraw[gray!50] (0,8) circle (6pt);
                    \filldraw[blue!50] (0,12) circle (6pt);
                    \filldraw[green!50] (3,10) circle (6pt);

                    % u, v, w
                    \filldraw[black] (0,8) circle (2pt) node[anchor=north east] {$u$};
                    \filldraw[black] (3,10) circle (2pt) node[anchor=south] {$w$};
                    \filldraw[black] (0,12) circle (2pt) node[anchor=north east] {$v$};
                    % x_1, x_2, x_3, x_4 + their negations
                    \filldraw[black] (6,8) circle (2pt) node[anchor=north west] {$x_1$};
                    \filldraw[black] (6,12) circle (2pt) node[anchor=north west] {$\overline{x_1}$};
                    \filldraw[black] (10,8) circle (2pt) node[anchor=north west] {$x_2$};
                    \filldraw[black] (10,12) circle (2pt) node[anchor=north west] {$\overline{x_2}$};
                    \filldraw[black] (14,8) circle (2pt) node[anchor=north west] {$x_3$};
                    \filldraw[black] (14,12) circle (2pt) node[anchor=north west] {$\overline{x_3}$};
                    \filldraw[black] (18,8) circle (2pt) node[anchor=north west] {$x_4$};
                    \filldraw[black] (18,12) circle (2pt) node[anchor=north west] {$\overline{x_4}$};
                    % logic gate graphs for each clause (c1, c2, c3)
                    \filldraw[black] (6,0) circle (2pt) node[anchor=south west] {$d_1$};
                    ...
                    % c2
                    \filldraw[black] (12,0) circle (2pt) node[anchor=south west] {$d_2$};
                    \filldraw[black] (11,1) circle (2pt);
                    \filldraw[black] (13,1) circle (2pt);
                    \filldraw[black] (11,2) circle (2pt);
                    \filldraw[black] (10,3) circle (2pt);
                    \filldraw[black] (12,3) circle (2pt);
                    % c3
                    \filldraw[black] (18,0) circle (2pt) node[anchor=south west] {$d_3$};
                    \filldraw[black] (17,1) circle (2pt);
                    \filldraw[black] (19,1) circle (2pt);
                    \filldraw[black] (17,2) circle (2pt);
                    \filldraw[black] (16,3) circle (2pt);
                    \filldraw[black] (18,3) circle (2pt);
                    % edges - u, v, w
                    \draw (0,8) to (3,10);
                    \draw (0,8) to (0,12);
                    \draw (0,12) to (3,10);
                    ...
                    \draw (3,10) to (18,12);
                    % edges - u, d_i
                    \draw (0,8) to [bend left] (2,1) to [bend left] (6,0);
                    \draw (0,8) to [bend left] (2,1) to [bend left] (12,0);
                    \draw (0,8) to [bend left] (2,1) to [bend left] (18,0);
                    % edges - d_1 triangles
                    \draw (5,1) to (7,1);
                    \draw (5,1) to (5,2);
                    \draw (5,1) to (6,0);
                    ...
                    \draw (17,2) to (18,3);
                    \draw (16,3) to (18,3);
                    % edges a_i, b_i, c_i -> x_i
                    \draw[draw=gray!35] (4,3) to [bend right] (6,8);
                    \draw[draw=gray!35] (6,3) to [bend right] (10,8);
                    \draw[draw=gray!35] (7,1) to [bend right] (18,12);
                    \draw[draw=gray!35] (10,3) to [bend left] (6,8);
                    \draw[draw=gray!35] (12,3) to [bend left] (10,12);
                    \draw[draw=gray!35] (13,1) to [bend left] (14,8);
                    \draw[draw=gray!35] (16,3) to [bend left] (10,12);
                    \draw[draw=gray!35] (18,3) to [bend left] (14,12);
                    \draw[draw=gray!35] (19,1) to [bend left] (18,8);
                \end{tikzpicture}
            }
            \caption{Sestrojený graf pro formuli}
            \label{fig:ukol-2-14-graph}
        \end{figure}

        Poté se pokusíme obarvit graf, tak že:
        \begin{itemize}
            \item Vrcholy $d_i$ musí být obarveny tak, aby byly různé od barvy $0$ (šedé).
            \item Vrcholy $x_i$ a $\overline{x_i}$ musí být obarveny tak, aby od sebe různé, barvami $0$ a $1$
            \item Pokud v každé klauzuli existují vrcholy $d_i$ takové, že jsou různé od barvy $0$, pak je formule
            splnitelná a graf je 3-obarvitelný.
        \end{itemize}

        Takové obarvení může být násludující:
        \begin{figure}[H]
            \centering
            \resizebox{0.4\paperwidth}{!}{
                \begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=3cm,semithick,y=-1cm]
                    ...
                    % color x_1 -> 1, x_2 -> 0, x_3 -> 0, x_4 -> 1
                    \filldraw[blue!50] (6,8) circle (6pt);
                    \filldraw[gray!50] (10,8) circle (6pt);
                    \filldraw[gray!50] (14,8) circle (6pt);
                    \filldraw[blue!50] (18,8) circle (6pt);
                    \filldraw[gray!50] (6,12) circle (6pt);
                    \filldraw[blue!50] (10,12) circle (6pt);
                    \filldraw[blue!50] (14,12) circle (6pt);
                    \filldraw[gray!50] (18,12) circle (6pt);
                    % color c_i graphs
                    \filldraw[green!50] (6,0) circle (6pt);
                    \filldraw[blue!50] (12,0) circle (6pt);
                    \filldraw[blue!50] (18,0) circle (6pt);

                    \filldraw[gray!50] (5,1) circle (6pt);
                    \filldraw[gray!50] (11,1) circle (6pt);
                    \filldraw[gray!50] (17,1) circle (6pt);

                    \filldraw[green!50] (5,2) circle (6pt);
                    \filldraw[blue!50] (11,2) circle (6pt);
                    \filldraw[blue!50] (17,2) circle (6pt);

                    \filldraw[gray!50] (4,3) circle (6pt);
                    \filldraw[gray!50] (10,3) circle (6pt);
                    \filldraw[green!50] (16,3) circle (6pt);

                    \filldraw[blue!50] (6,3) circle (6pt);
                    \filldraw[green!50] (12,3) circle (6pt);
                    \filldraw[gray!50] (18,3) circle (6pt);

                    \filldraw[blue!50] (7,1) circle (6pt);
                    \filldraw[green!50] (13,1) circle (6pt);
                    \filldraw[green!50] (19,1) circle (6pt);
            ...
            \caption{Obarvený graf pro formuli}
            \label{fig:ukol-2-14-graph-colored}
        \end{figure}

        Dosazením do formule zjistíme, že všechny klauzule jsou splněny:
        \begin{equation*}
            f(x_1=1, x_2=0, x_3=0, x_4=1) =
            (1 \lor 0 \lor 0) \land
            (1 \lor 1 \lor 0) \land
            (1 \lor 1 \lor 1) = 1
        \end{equation*}

        Obarvení jsme v grafu našli a tedy je formule splnitelná a graf je 3-obarvitelný.

        Podrobnější postup je vidět na obrázku~\ref{fig:ukol-2-14-hand} níže:
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{\FIGDIR/ukol-2-14-hand}
            \caption{Postup obarvení grafu}
            \label{fig:ukol-2-14-hand}
        \end{figure}

        \answerbox{
            Formule je splněna a graf je 3-obarvitelný pro $x_1 = 1, x_2 = 0, x_3 = 0, x_4 = 1$.
        }{}
    \end{uloha}
